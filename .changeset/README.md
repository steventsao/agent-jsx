...
Choose `@agent-jsx/core`, select the semver impact, and describe the user-visible change. Documentation, tests, examples, and CI-only changes do not need a changeset.
