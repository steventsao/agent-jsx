...
import chess_goal_matchAgent from "./chess-goal-match.flue.ts";
...
type State = typeof ChessGoalMatch.spec.initialState & Record<string, unknown>;
const PROPS = {};

export default defineWorkflow({
  agent: chess_goal_matchAgent,
  ...
  run: async (context) => {
    ...
    const initialState = (context.input.state ?? ChessGoalMatch.spec.initialState) as State;
