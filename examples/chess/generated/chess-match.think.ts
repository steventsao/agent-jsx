...
const CHESS_MATCH_DEFINITION = ChessMatch.spec.resolveDefinition!(CHESS_MATCH_PROPS as never, createStore(ChessMatch.spec.initialState));
...
export class ChessMatchDurable extends ThinkAgentBase<ChessMatchState> {
  ...
  protected renderedDefinition() {
    return ChessMatch.spec.resolveDefinition!(this.turnProps(CHESS_MATCH_PROPS) as never, this.boundStore<ChessMatchState>());
  }
