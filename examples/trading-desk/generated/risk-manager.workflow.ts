...
import risk_managerAgent from "./risk-manager.flue.ts";
...
export default defineWorkflow({
  ...
  run: async (context) => {
    ...
    const initialState = (context.input.state ?? TradingDesk.spec.initialState) as State;
